...
function Navbars() {
  ...
  return (
    <>
      <Navbar collapseOnSelect expand="md" variant="dark" class="navbar">
        <Container>
          ...
          >
            <Nav className="me-auto" id="subList">
              <Nav.Link id="animate" href="/overview">
                Overview
              </Nav.Link>
              <Nav.Link id="animate" href="/groceries">
                Grocery
              </Nav.Link>
      ...
      <div class="custom-shape-divider-top-1626500503">
        <svg
          data-name="Layer 1"
